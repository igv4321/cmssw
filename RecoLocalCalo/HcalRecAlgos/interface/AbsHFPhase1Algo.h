...
public:
    ...
    // If using DB, update the configuration once per run.
    // We will not manage the pointer here. "true" should
    // be returned on success (typically, pointer checked
    // by the appropriate dynamic cast).
